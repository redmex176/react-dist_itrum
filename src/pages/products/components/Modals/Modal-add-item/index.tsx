                    ...
                    <ul className={styles.form__list}>
                        <li>
                            ...
                            <input
                                ...
                                onChange={({ target: { value } }) =>
                                    setNewItem({ ...newItem, cashback: value })
                                }
                            />
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            >
                                ...
                                <option value="Название подкатегории1">
                                    Название подкатегории1
                                </option>
                                <option value="Название подкатегории2">
                                    Название подкатегории2
                                </option>
                            </select>
                        </li>
                        <li>
